...
//        ArrayList<Product> vI = c.getCart().getVendorItems();
        ...
        int qty = (int) mQuantity.getSelectedItem();
    ...
    private void mNameMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mNameMouseClicked
        // TODO add your handling code here
//        GUI_ViewProduct vp = new GUI_ViewProduct(mP,);
//        vp.setAlignmentX(CENTER_ALIGNMENT);
//        vp.setAlignmentY(CENTER_ALIGNMENT);
//        Agora.desktop.add(vp);
//        vp.setVisible(true);
